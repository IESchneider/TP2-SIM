...
namespace TP2_SIM.Distribuciones
{
    internal class ExponencialNegativa
    {
        ...
        public void GenerarDistribucion(Object exponencialNegativa)
        {   
        ...
        {
            // double frecuenciaEsperada = (log.FrecuenciaExponencial(Lambda, limiteSuperior) - log.FrecuenciaExponencial(Lambda, limiteInferior)) * CantidadMuestra;
